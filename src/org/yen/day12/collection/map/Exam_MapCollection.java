package org.yen.day12.collection.map;
...
public class Exam_MapCollection {
	...
	public static void main(String[] args) {
		...
		System.out.println("첫번째 학생 : "+stdMap.get(2));
	...
	public Map<String, Object> mapExercise() {
		...
		// -> {"name":name, "salary":salary, "isWorkgin":isWorking}
		return memberInfo;
		}
	...
	public void megaSample() {
		...
		String name = (String)objMap.get("name");	//오른쪽은 obj타입이므로 string으로 형변환해줌
	...
	public void basicSample() {
		...
		map.put("02", "서울"); 	// key에 해당하는 value값을 넣을때 put을 사용한다.
		map.put("031", "경기도");
		map.put("032", "인천");
		map.put("051", "부산");
		map.put("064", "제주도");
		System.out.println("저장된 데이터의 수 : "+map.size());
		System.out.println("02를 누르면 서울이 나옵니다 : "+map.get("02"));		//get은 key를 안에 넣으면 value값을 반환한다.
		...
		do{
			...
			if(result!=null) 
				...
				System.out.println("데이터가 존재하지 않습니다.02");
